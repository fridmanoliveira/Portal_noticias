<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                <h2 class="text-2xl font-bold text-gray-800">Categorias de Notícias</h2>
                <p class="mt-1 text-sm text-gray-500">Organize as categorias do seu conteúdo</p>
            </div>
        ...
        <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
            ...
            <div class="overflow-hidden bg-white shadow-sm rounded-xl">
                ...
                <div class="px-6 py-4 border-b border-gray-100 bg-gray-50">
                    <div class="flex items-center justify-between">
                        <h3 class="text-lg font-medium text-gray-700">Categorias Cadastradas</h3>
                        <div class="relative">
                                ...
                                <tr class="transition-colors hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex justify-center space-x-2">
                                            ...
                                            <form action="{{ route('admin.categorias-noticias.destroy', $categoria->id) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit"
                                                        class="p-2 text-gray-500 transition-colors rounded-full hover:bg-gray-100 hover:text-red-600"
                                                        title="Excluir"
                                                        onclick="return confirm('Tem certeza que deseja excluir esta categoria? Isso também pode afetar notícias relacionadas!')">
                                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            @empty
                                <tr>
                                    <td colspan="3" class="px-6 py-8 text-center text-gray-500">
                                        ...
                                        <p class="mt-4 text-lg font-medium text-gray-600">Nenhuma categoria encontrada</p>
                                        <p class="mt-1 text-gray-500">Adicione novas categorias clicando no botão "Nova Categoria"</p>
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
