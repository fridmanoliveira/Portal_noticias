<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                <h2 class="text-2xl font-bold text-gray-800">{{ __('Editar Fiscal') }}</h2>
                <p class="mt-1 text-sm text-gray-500">Atualize os dados de {{ $fiscal->nome }}</p>
            </div>
        </div>
    </x-slot>
        ...
        <div class="max-w-4xl px-4 mx-auto sm:px-6 lg:px-8">
            <div class="overflow-hidden bg-white shadow-sm rounded-xl">
                <div class="p-6 bg-white border-b border-gray-200">
                    <form method="POST" action="{{ route('admin.fiscais.update', $fiscal->id) }}" class="space-y-6">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="grid grid-cols-1 gap-6 md:grid-cols-3">
                            ...
                            <div>
                                ...
                                <div class="mt-1">
                                    <input type="text" name="nome" id="nome" value="{{ old('nome', $fiscal->nome) }}" required
                            ...
                            <div>
                                ...
                                <div class="mt-1">
                                    <input type="text" name="crea" id="crea" value="{{ old('crea', $fiscal->crea) }}" required
                            ...
                            <div>
                                ...
                                <div class="mt-1">
                                    <input type="text" name="cpf" id="cpf" value="{{ old('cpf', $fiscal->cpf) }}" required
