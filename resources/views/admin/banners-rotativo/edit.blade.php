<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                <h2 class="text-2xl font-bold text-gray-800">{{ __('Editar Banner Rotativo') }}</h2>
        ...
        <div class="max-w-4xl px-4 mx-auto sm:px-6 lg:px-8">
            <div class="overflow-hidden bg-white shadow-sm rounded-xl">
                <div class="p-6 bg-white border-b border-gray-200">
                    <form action="{{ route('admin.banners-rotativo.update', $banners_rotativo) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                        @csrf
                        @method('PUT')
                        ...
                        <div>
                            ...
                            <div class="mt-1">
                                <input type="text" name="titulo" id="titulo" value="{{ old('titulo', $banners_rotativo->titulo) }}" required
                            ...
                            <div>
                                ...
                                <div class="flex flex-col items-center justify-center mt-1">
                                    <div class="w-full h-48 border-2 border-gray-300 rounded-lg bg-gray-50">
                                        <img id="preview" src="{{ url($banners_rotativo->imagem) }}"
                                            class="object-contain w-full h-full"
                                            alt="Banner atual"
                                            onerror="this.style.display='none';">
                                        <div id="no-image" class="{{ $banners_rotativo->imagem ? 'hidden' : 'flex' }} items-center justify-center w-full h-full text-gray-400">
                        ...
                        <div>
                            ...
                            <div class="mt-1">
                                <input type="url" name="link" id="link" value="{{ old('link', $banners_rotativo->link) }}"
                                    class="block w-full px-4 py-3 border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-[#0596A2] focus:border-[#0596A2] placeholder-gray-400">
                            </div>
                            @error('link')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        ...
                        <div>
                            ...
                            <div class="mt-1">
                                <input type="number" name="ordem" id="ordem" value="{{ old('ordem', $banners_rotativo->ordem) }}"
                                    class="block w-full px-4 py-3 border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-[#0596A2] focus:border-[#0596A2] placeholder-gray-400">
                            </div>
                        ...
                        <div class="flex items-start">
                            <div class="flex items-center h-5">
                                <input id="carrossel" name="carrossel" type="checkbox" value="1" {{ old('carrossel', $banners_rotativo->carrossel) ? 'checked' : '' }}
                        ...
                        <div class="flex items-start">
                            <div class="flex items-center h-5">
                                <input id="ativo" name="ativo" type="checkbox" value="1" {{ old('ativo', $banners_rotativo->ativo) ? 'checked' : '' }}
                                    class="w-4 h-4 text-[#0596A2] border-gray-300 rounded focus:ring-[#0596A2]">
                            </div>
                            <div class="ml-3 text-sm">
