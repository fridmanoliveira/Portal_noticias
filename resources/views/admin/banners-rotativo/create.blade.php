<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                <h2 class="text-2xl font-bold text-gray-800">{{ __('Novo Banner Rotativo') }}</h2>
                <p class="mt-1 text-sm text-gray-500">Adicione um novo banner ao carrossel da página inicial</p>
            </div>
        </div>
    </x-slot>
                    ...
                    <form action="{{ route('admin.banners-rotativo.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                            ...
                            <div>
                                ...
                                <div class="flex flex-col items-center justify-center mt-1">
                                    <div class="w-full h-48 border-2 border-gray-300 border-dashed rounded-lg bg-gray-50">
                                        <img id="preview" class="object-contain w-full h-full" alt="Pré-visualização do banner" />
                                    </div>
                                    <p id="file-name" class="mt-2 text-xs text-gray-500">Nenhuma imagem selecionada</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start">
                            <div class="flex items-center h-5">
                                <input id="carrossel" name="carrossel" type="checkbox" value="1" {{ old('carrossel') ? 'checked' : '' }}
