            ...
            <div class="p-8 bg-white shadow-xl rounded-2xl">
                ...
                <form method="POST" action="{{ route('admin.questions.store') }}">
                    ...
                    <div class="mt-4">
                        ...
                        <div id="options-container" class="space-y-2">
                            <div class="flex gap-2">
                                ...
                                <button type="button" class="px-3 py-2 text-white bg-red-500 rounded-lg hover:bg-red-600" onclick="removeOption(this)">X</button>
                            </div>
                        </div>
                    ...
                    <div class="flex justify-end gap-4 pt-4">
                        ...
                        <button type="submit" class="px-6 py-2 text-sm font-medium text-white bg-blue-600 rounded-lg hover:bg-blue-700">Salvar Questão</button>
                    </div>
                </form>
            </div>
        </div>
