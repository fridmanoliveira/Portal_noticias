                            ...
                            @forelse ($banners as $banner)
                                <tr class="transition-colors hover:bg-gray-50">
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center justify-center w-24 h-16 overflow-hidden bg-gray-100 rounded-md">
                            ...
                            @empty
                                <tr>
                                    <td colspan="5" class="px-6 py-8 text-center text-gray-500">
                                        ...
                                        <p class="mt-4 text-lg font-medium text-gray-600">Nenhum banner encontrado</p>
