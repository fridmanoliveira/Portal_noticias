...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="bg-gray-100">
        ...
        <section class="py-10 bg-[#f5f7fe]">
            <div class="grid gap-6 px-4 mx-auto sm:container md:grid-cols-3">
                <!-- Cartão 1 -->
                <a href="#" class="flex items-center gap-4 px-6 py-5 text-white rounded-lg shadow-md transition-all hover:shadow-lg bg-gradient-to-r from-[#008f9c] to-[#005d6d] h-32">
                    <img src="{{ asset('icons/searching.png') }}" alt="Ícone Portal" class="w-12 h-12">
                    <span class="text-base italic font-bold leading-tight">PORTAL DA<br>TRANSPARÊNCIA</span>
                </a>

                <!-- Cartão 2 -->
                <a href="#" class="flex items-center gap-4 px-6 py-5 text-white rounded-lg shadow-md transition-all hover:shadow-lg bg-gradient-to-r from-[#008f9c] to-[#005d6d]">
                    <img src="{{ asset('icons/support.png') }}" alt="Ícone Ouvidoria" class="w-12 h-12">
                    <span class="text-base italic font-bold leading-tight">OUVIDORIA DE<br>CRISTINO CASTRO</span>
                </a>

                <!-- Cartão 3 -->
                <a href="#" class="flex items-center gap-4 px-6 py-5 text-white rounded-lg shadow-md transition-all hover:shadow-lg bg-gradient-to-r from-[#008f9c] to-[#005d6d]">
                    <img src="{{ asset('icons/radar.png') }}" alt="Radar Nacional" class="w-12 h-12 bg-white rounded">
                    <span class="text-base italic font-bold leading-tight">RADAR NACIONAL DA<br>TRANSPARÊNCIA PÚBLICA</span>
                </a>
            </div>
        </section>

        <!-- Banner Coral Jovem -->
        <section class="px-4 py-8 mx-auto sm:container">
        ...
        <section class="px-4 py-12 mx-auto max-w-7xl">
            <h2 class="mb-6 text-xl italic font-extrabold text-gray-700">ACESSO RÁPIDO</h2>
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                @foreach($acessosRapidos as $acesso)
                    <a href="{{ $acesso->link }}"
                    class="flex flex-col items-start justify-between h-full p-6 text-white transition-transform duration-300 rounded-lg shadow-md bg-gradient-to-r from-[#008f9c] to-[#005d6d] hover:scale-105">
                        <img src="{{ asset('storage/' . $acesso->icone) }}"
                            alt="{{ $acesso->titulo }}"
                            class="w-10 h-10 mb-4">
                        <p class="text-lg font-bold leading-tight">{{ $acesso->titulo }}</p>
                        <p class="mt-2 text-sm opacity-80">Clique para acessar</p>
                    </a>
                @endforeach
            </div>
        </section>
        ...
        <section class="relative bg-center bg-cover" style="background-image: url('{{ asset('storage/fundo.png') }}')">
            ...
            <div class="bg-teal-900 bg-opacity-70">
                <div class="grid items-center grid-cols-1 gap-10 px-6 py-16 mx-auto sm:container md:grid-cols-2">

                    <!-- Texto -->
                    <div class="text-white">
                        <h2 class="mb-4 text-3xl font-extrabold leading-snug">
                    ...
                    <div class="flex items-center justify-center w-full rounded-lg shadow-md h-72">
                ...
                <div class="py-6 text-center">
                    <a href="#" class="inline-block px-6 py-3 font-bold text-white transition bg-[#1DC98A]/50 rounded-md shadow-md hover:bg-[#1DC98A] hover:bg-opacity-70">
