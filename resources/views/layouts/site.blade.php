            ...
            <div class="flex flex-wrap items-center justify-between gap-2">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <div class="flex gap-1">
                        ...
                        <a href="https://www.youtube.com/channel/UCqSzQF-nWHhU49n5_9XSTWg" class="p-2 transition-colors rounded-full bg-white/10 hover:bg-white/20">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <div class="flex flex-col items-center gap-8 p-4 bg-[#004348] rounded-lg sm:gap-6 sm:p-6 md:flex-row md:justify-start md:items-start">
                ...
                <div class="text-center md:ml-auto">
                    ...
                    <div class="flex justify-center gap-3 sm:gap-4">
                        ...
                        <a href="https://www.youtube.com/@PrefeituradeCristinoCastro" class="p-2 transition-colors rounded-full bg-white/10 hover:bg-white/20">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                <path d="M19.615 3.184c-3.604-.246-11.631-.245-15.23 0-3.897.266-4.356 2.62-4.385 8.816.029 6.185.484 8.549 4.385 8.816 3.6.245 11.626.246 15.23 0 3.897-.266 4.356-2.62 4.385-8.816-.029-6.185-.484-8.549-4.385-8.816zm-10.615 12.816v-8l8 3.993-8 4.007z"></path>
                            </svg>
                        </a>
