            ...
            <div class="max-w-4xl mx-auto overflow-hidden bg-white shadow-lg rounded-xl">
                ...
                <div class="p-6 text-white bg-gradient-to-r from-blue-700 to-blue-600">
                    <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                        <div>
                            <h1 class="text-2xl font-bold">PPA Participativo 2023-2026</h1>
                        ...
                        <div class="px-4 py-2 mt-4 text-sm bg-blue-800 bg-opacity-50 rounded-lg md:mt-0">
                            <p>Consulta Pública nº 012/2023</p>
                            <p class="mt-1 text-xs">Período: 01/09 a 30/11/2023</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="px-6 py-3 border-b border-blue-100 bg-blue-50">
                    <div class="flex items-center justify-between mb-1">
                        ...
                        <span class="text-sm font-medium text-blue-600">25% completo</span>
                    </div>
                ...
                <form action="{{ route('ppa.submit') }}" method="POST" class="p-6 space-y-8 md:p-8">
                    ...
                    <div class="p-5 border-l-4 border-blue-600 rounded-r-lg bg-blue-50">
                        ...
                        <p class="mt-2 text-gray-700">Este formulário faz parte do processo democrático de construção do Plano Plurianual (PPA) 2023-2026. Suas respostas ajudarão a definir as prioridades para os próximos 4 anos em nosso município.</p>
