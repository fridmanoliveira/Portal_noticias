...
`;function V(t=!1){let e=document.querySelector(".asw-rg-container");if(t){if(!e){e=document.createElement("div"),e.classList.add("asw-rg-container"),e.innerHTML=`<style>${rt}</style>${st}`;let i=e.querySelector(".asw-rg-top"),a=e.querySelector(".asw-rg-bottom"),s=20;window.__asw__onScrollReadableGuide=u=>{i.style.height=`${u.clientY-s}px`,a.style.height=`${window.innerHeight-u.clientY-s*2}px`},document.addEventListener("mousemove",window.__asw__onScrollReadableGuide,{passive:!1}),document.body.appendChild(e)}}else e?.remove(),window.__asw__onScrollReadableGuide&&(document.removeEventListener("mousemove",window.__asw__onScrollReadableGuide),delete window.__asw__onScrollReadableGuide)}var ei={id:"highlight-links",selector:"html",childrenSelector:at,styles:{outline:"2px solid #07757f","outline-offset":"2px"}};function W(t=!1){c({...ei,enable:t})}var ii={id:"letter-spacing",selector:"html",childrenSelector:m,styles:{"letter-spacing":"2px"}};function P(t=!1){c({...ii,enable:t})}var ni={id:"line-height",selector:"html",childrenSelector:m,styles:{"line-height":"3"}};function K(t=!1){c({...ni,enable:t})}var oi={id:"font-weight",selector:"html",childrenSelector:m,styles:{"font-weight":"700"}};function N(t=!1){c({...oi,enable:t})}function w(){let t=r?.states;G(t["highlight-title"]),W(t["highlight-links"]),P(t["letter-spacing"]),K(t["line-height"]),N(t["font-weight"]),B(t["readable-font"]),V(t["readable-guide"]),E(t["stop-animations"]),O(t["big-cursor"])}var lt = {
  "dark-contrast": {
    css: `
      ...
      /* --- FUNDO E TEXTO BASE --- */
      html.aws-filter, html.aws-filter body {
        background-color: #121212 !important;
        color: #e8e6e3 !important;
      }
      html.aws-filter .bg-white {
        background-color: #1e1e1e !important;
        border-color: #444 !important;
      }

      /* --- CABEÇALHO E RODAPÉ --- */
      html.aws-filter header[class*="bg-"], html.aws-filter footer[class*="bg-"] {
          background-color: #0d3a3e !important;
      }
      html.aws-filter header a, html.aws-filter header span, html.aws-filter header p, html.aws-filter header button {
          color: #FFF !important;
      }
      html.aws-filter header div.bg-white {
          background-color: #2d2d2d !important;
          border: 1px solid #444 !important;
      }
      html.aws-filter header div.bg-white a:hover {
          background-color: #3e3e3e !important;
      }
      html.aws-filter header img {
          filter: brightness(0) invert(1) !important;
      }
      html.aws-filter footer a:hover {
        color: #86efac !important;
      }

      /* --- TÍTULOS E TEXTOS COMUNS --- */
      html.aws-filter h1, html.aws-filter h2, html.aws-filter h3 {
          color: #FFF !important;
      }
      html.aws-filter .text-gray-500, html.aws-filter .text-gray-600, html.aws-filter .text-gray-700, html.aws-filter .text-gray-800 {
          color:rgb(254, 254, 254) !important;
      }
      html.aws-filter .text-teal-600, html.aws-filter .text-teal-700, html.aws-filter .text-teal-800 {
          color: #2dd4bf !important;
      }
      html.aws-filter .text-teal-600:hover, html.aws-filter .text-teal-700:hover, html.aws-filter .text-teal-800:hover {
          color: #5eead4 !important;
      }

      /* --- FORMULÁRIOS E BOTÕES --- */
      html.aws-filter label {
          color: #e0e0e0 !important;
      }
      html.aws-filter input, html.aws-filter select, html.aws-filter textarea {
          background-color: #252525 !important;
          color: #e8e6e3 !important;
          border-color: #555 !important;
      }
      /* NOVO: Inverte a cor do ícone de calendário nos campos de data. */
      html.aws-filter input[type="date"]::-webkit-calendar-picker-indicator {
          filter: invert(1) !important;
      }
      html.aws-filter .bg-gray-300 {
          background-color: #4a4a4a !important;
          color: #FFF !important;
      }
      html.aws-filter .bg-gray-300:hover {
          background-color: #5a5a5a !important;
      }

      /* --- PAGINAÇÃO --- */
      html.aws-filter ul li a[href][class*="text-teal-800"] {
          color: #2dd4bf !important;
      }
      html.aws-filter ul li a[href][class*="text-teal-800"]:hover {
          background-color: #0d3a3e !important;
      }

      /* --- OUTROS ELEMENTOS --- */
      html.aws-filter div[class*="bg-"][class*="text-white"] a:hover {
        text-decoration: underline !important;
      }
      html.aws-filter a[class*="from-[#008f9c]"] {
          color: #FFF !important;
      }
      html.aws-filter svg {
